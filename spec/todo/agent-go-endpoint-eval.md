...
| GET | /accounts/data | Missing |
| GET | /rollover/{account_id} | Missing |
| POST | /accounts/{account_id}/rollover | Missing |
| GET | /confirmation/{rollover_id} | Missing |
...
| POST | /{id}/versions | Missing |
| PATCH | /{id}/set-current | Missing |
