...
import { Trash2, Download, Plus, X, Upload } from "lucide-react";
...
interface DocumentsSectionProps {
  ...
  // For create mode - collect document IDs to link after entity creation
  pendingDocumentIds?: number[];
  onPendingDocumentIdsChange?: (ids: number[]) => void;
}
...
const DocumentsSection = ({
  ...
  const handleRemovePendingDocument = (documentId: number) => {
    ...
    <div className="space-y-2">
      ...
      <div className="space-y-2">
        {displayDocuments.map((doc) =>
          renderDocumentCard(doc, isCreateMode)
        )}
      </div>
