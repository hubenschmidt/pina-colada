        ...
        <div className="space-y-6 text-zinc-700">
          ...
          <section>
            ...
            <p>
              ...
              without your consent, except as described in this Privacy Policy or as required by law. We may share
              information with:
            </p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-800 mb-3">5. Authentication Services</h2>
            <p>
              We use Auth0 for authentication services. When you create an account or log in, Auth0 processes your
              authentication information in accordance with their privacy policy. We recommend reviewing Auth0's
          ...
          <section>
            <h2 className="text-xl font-semibold text-blue-800 mb-3">10. Changes to This Privacy Policy</h2>
            <p>
