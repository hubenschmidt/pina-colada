...
type AutomationConfig struct {
	...
	MinProspectsThreshold int     `gorm:"column:min_prospects_threshold;not null;default:5" json:"min_prospects_threshold"`
	...
	VectorMaxResults           int       `gorm:"column:vector_max_results;not null;default:10" json:"vector_max_results"`
