...
BEGIN
    ...
    VALUES (
        ...
        2,
        40,
        '[["senior software engineer", "nyc"], ["full stack developer", "nyc"]]'::jsonb,
        true,
        'week',
        'individual',
        ...
        true,
        'gpt-5.2',
        'Please job search for matches using the resume linked on his Individual record. Jobs should be located in NYC and at startups (seed, series A, B, and C).',
        true,
    ...
    ON CONFLICT (tenant_id, user_id, name) DO UPDATE SET
        ...
        search_slots = EXCLUDED.search_slots,
