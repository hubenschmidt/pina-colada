...
BEGIN
    ...
    VALUES (
        ...
        1,
        40,
        '(senior OR staff) software engineer -junior -intern -entry',
        true,
        'New York',
        true,
        'week',
    ...
    ON CONFLICT (tenant_id, user_id, name) DO UPDATE SET
        ...
        vector_prefilter_enabled = EXCLUDED.vector_prefilter_enabled,
        vector_similarity_threshold = EXCLUDED.vector_similarity_threshold,
        use_analytics = EXCLUDED.use_analytics,
