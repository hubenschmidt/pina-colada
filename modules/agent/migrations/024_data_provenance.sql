...
CREATE INDEX IF NOT EXISTS idx_provenance_entity ON "DataProvenance"(entity_type, entity_id);
CREATE INDEX IF NOT EXISTS idx_provenance_field ON "DataProvenance"(entity_type, entity_id, field_name);
CREATE INDEX IF NOT EXISTS idx_provenance_stale ON "DataProvenance"(verified_at);
