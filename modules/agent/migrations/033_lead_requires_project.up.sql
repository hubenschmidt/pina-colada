...
BEGIN
    ...
    -- the Lead_Project association in the same transaction
...
COMMENT ON TABLE "Lead_Project" IS 'Junction table for Lead-Project many-to-many relationship. All leads must have at least one project association (enforced at application level).';
